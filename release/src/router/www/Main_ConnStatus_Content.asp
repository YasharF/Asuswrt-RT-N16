						...
						<tr bgcolor="#4D595D">
							<td valign="top">
								...
								<div style="margin-top:8px">   
									<textarea style="width:98%; font-family:'Courier New', Courier, mono; font-size:13px;background:#475A5F;color:#FFFFFF;" cols="63" rows="25" readonly="readonly" wrap=off><% nvram_dump("syscmd.log","../usr/sbin/netstat-nat -r state -xn > /tmp/syscmd.log 2>&1"); %></textarea>
								</div>
								<div class="apply_gen">
