...
Automatically generated on Mon Jan 27 19:02:48 PST 2014
...
int qcsapi_wifi_get_dscp_ac_map(const char * ifname, string_64 mapping_table)
{
	int retries = 0;
	CLIENT *clnt = qcsapi_adapter_get_client();
	enum clnt_stat __rpcret;
...
int qcsapi_wifi_set_dscp_ac_map(const char * ifname, uint8_t * dscp_list, uint8_t dscp_list_len, uint8_t ac)
{
	int retries = 0;
	CLIENT *clnt = qcsapi_adapter_get_client();
	enum clnt_stat __rpcret;
...
int qcsapi_wifi_create_restricted_bss(const char * ifname)
{
	int retries = 0;
	CLIENT *clnt = qcsapi_adapter_get_client();
	enum clnt_stat __rpcret;
...
int qcsapi_wifi_create_bss(const char * ifname)
{
	int retries = 0;
	CLIENT *clnt = qcsapi_adapter_get_client();
	enum clnt_stat __rpcret;
...
int qcsapi_wps_set_ap_pin(const char * ifname, char * wps_pin)
{
	int retries = 0;
	CLIENT *clnt = qcsapi_adapter_get_client();
	enum clnt_stat __rpcret;
