...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --arch=mips --cross-prefix=mipsel-linux- --enable-shared --disable-static --enable-nonfree --disable-doc --enable-pthreads --enable-small --disable-encoders --disable-filters --disable-muxers --disable-devices --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-debug
...
SRC_PATH=$(FFMPEG_HOME)
SRC_PATH_BARE=$(FFMPEG_HOME)
BUILD_ROOT=$(FFMPEG_HOME)
ARCH=mips
CC=mipsel-linux-gcc
AS=mipsel-linux-gcc
LD=mipsel-linux-gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Os -fno-math-errno -fno-tree-vectorize
ASFLAGS=   -fPIC
CC_O=-o $@
...
libavformat_VERSION=52.41.0
libavformat_VERSION_MAJOR=52
libavutil_VERSION=50.5.1
