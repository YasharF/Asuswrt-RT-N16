...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=mips --cross-prefix=mipsel-linux- --enable-shared --disable-static --enable-nonfree --disable-doc --enable-pthreads --enable-small --disable-encoders --disable-filters --disable-muxers --disable-devices --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-debug"
