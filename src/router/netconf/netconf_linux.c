 ...
 *
 * $Id: netconf_linux.c,v 1.31 2008/11/20 22:52:53 Exp $
 */
...
//	"POSTROUTING", "PREROUTING", "POSTROUTING"
	"POSTROUTING", "VSERVER", "POSTROUTING"
};
...
//		if (!insert_entry("VSERVER", ipt_target_name[fw->target], entry, &handle)) {
#else /* LINUX26 */
