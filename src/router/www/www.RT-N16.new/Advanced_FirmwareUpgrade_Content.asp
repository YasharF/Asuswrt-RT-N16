...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			<tr>
				<th width="200"><#FW_item1#></th>
				<td><input type="text" class="input" value="<% nvram_get_f("general.log","productid"); %>" readonly="1"></td>
			</tr>
			<tr>
				<th><#FW_item2#></th>
				<td><input type="text" name="firmver" class="input" value="<% nvram_get_f("general.log","firmver"); %>" readonly="1"></td>
			</tr>
			<tr>
				<th><#FW_item5#></th>
				<td>
				<input type="file" name="file" class="input" style="cursor:pointer;" size="20">
				</td>
			</tr>
			<tr align="center">
