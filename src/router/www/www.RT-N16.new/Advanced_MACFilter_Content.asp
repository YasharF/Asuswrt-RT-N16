	...
	if(document.form.macfilter_enable_x.value == "1"){
		if(macfilter_num_x == 0){
			if(confirm("<#FirewallConfig_MFList_accept_hint1#>")){
				...
				markGroup(document.form.MFList, 'MFList', 16, ' Add ');
				document.form.submit();
			}
			else
				return false;
	  ...
	  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
        ...
        <tr>
          ...
          <td><input type="text" maxlength="12" class="input" size="20" name="macfilter_list_x_0" onKeyPress="return is_hwaddr()">
   		  	  <input class="button" type="submit" onclick="markGroup(this, 'MFList', 16, ' Add ');" name="MFList" value="<#CTL_add#>" size="12"/>
        ...
        <tr>
		  ...
		  <input class="button" type="submit" onClick="return markGroup(this, 'MFList', 16, ' Del ');" name="MFList" value="<#CTL_del#>" size="12">
		  </td>
        </tr>
		<tr align="right">
          <td colspan="2" >
