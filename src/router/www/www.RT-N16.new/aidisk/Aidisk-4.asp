...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	<tr>
      ...
      <tr>
		 ...
		 <!--[if lte IE 6.5]><li><#linktodisk#><a href="\\<%nvram_get_x("LANHostConfig", "computer_name"); %>" target="_blank">\\<%nvram_get_x("LANHostConfig", "computer_name"); %></a></li><![endif]-->
         <li>
          ...
          <div id="noDDNS" class="ServerClose" style="display:none;">
          	  <#linktoFTP_no_2#>
          </div>
