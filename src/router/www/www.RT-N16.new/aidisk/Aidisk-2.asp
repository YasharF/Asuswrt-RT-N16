...
<body onload="initial();">
<form method="post" name="smartForm" id="smartForm" action="Aidisk-3.asp">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          <td colspan="2" valign="top" class="textbox">
            <p><#Step2_method#></p>
            <p><input type="radio" name="dummyoption" value="0" onclick="showTextinWizard(this.value);"/> <#Step2_method1#></p>
            <p><input type="radio" name="dummyoption" value="1" onclick="showTextinWizard(this.value);"/> <#Step2_method2#></p>
            <p><input type="radio" name="dummyoption" value="2" onclick="showTextinWizard(this.value);"/> <#Step2_method3#></p>
            <div id="share1">
