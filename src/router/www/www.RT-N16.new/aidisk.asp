...
function createAccount(){
	if(accounts[0]){
		...
		/*alert("action = "+document.applyForm.action+"\n"+
			  "account = "+document.applyForm.account.value+"\n"+
			  "permission = "+document.applyForm.password.value);//*/
		document.applyForm.submit();
	}
	else
...
function submitChangePermission(protocol){
	if(pools && pools.length > 0){
		if(pools_status[0] == "rw"
			...
			/*alert("action = "+document.applyForm.action+"\n"+
				  "account = "+document.applyForm.account.value+"\n"+
				  "pool = "+document.applyForm.pool.value+"\n"+
				  "folder = "+document.applyForm.folder.value+"\n"+
				  "protocol = "+document.applyForm.protocol.value+"\n"+
				  "permission = "+document.applyForm.permission.value);//*/
			document.applyForm.submit();
			return;
		}
...
function switchShareMode(protocol, mode){
	...
	/*alert("action = "+document.applyForm.action+"\n"+
		  "protocol = "+document.applyForm.protocol.value+"\n"+
		  "mode = "+document.applyForm.mode.value);//*/
	document.applyForm.submit();
}
...
function switchAppStatus(protocol, flag){
	...
	/*alert("action = "+document.applyForm.action+"\n"+
		  "protocol = "+document.applyForm.protocol.value+"\n"+
		  "flag = "+document.applyForm.flag.value);//*/
	document.applyForm.submit();
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
		<td align="left" valign="top">
			<iframe id="sub_frame" src="" width="98%" height="455" frameborder="0" scrolling="no"></iframe>
		</td>
				...
				<table width="100%" cellpadding="0" cellspacing="1" class="Help" bgcolor="#999999">
					...
					<tr>
						<td valign="top">
							...
							<iframe id="statusframe" name="statusframe" class="statusframe" src="Aidisk-1_help.asp" frameborder="0"></iframe>
						</td>
					</tr>
				</table>
			</div>
