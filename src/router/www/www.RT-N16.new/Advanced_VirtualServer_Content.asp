	  ...
	  <td bgcolor="#FFFFFF"><#IPConnection_VServerEnable_sectiondesc#>
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
          <tr>
            ...
            <td colspan="3">
						  <input type="radio" value="1" name="vts_enable_x" onclick="return change_common_radio(this, 'IPConnection', 'vts_enable_x', '1')" <% nvram_match_x("IPConnection","vts_enable_x", "1", "checked"); %>><#checkbox_Yes#>
						  <input type="radio" value="0" name="vts_enable_x" onclick="return change_common_radio(this, 'IPConnection', 'vts_enable_x', '0')" <% nvram_match_x("IPConnection","vts_enable_x", "0", "checked"); %>><#checkbox_No#>
            </td>
		  </tr>
		...
		<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" class="FormTable">
          ...
          <tr>
            ...
            <th width="115" style="text-align:center;"><#IPConnection_VServerPort_itemname#></th>
            <th width="125" style="text-align:center;"><#IPConnection_VServerIP_itemname#></th>
