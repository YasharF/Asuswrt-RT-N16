...
function showTriggerList(){
	...
	if(TriggerList.length == 0)
		...
		if(i == 0)
			code +="<td width='75' style='background:#C0DAE4;' rowspan=" + TriggerList.length + "><input style=\"padding:2px 2px 0px 2px\" class=\"button\" type=\"submit\" onclick=\"markGroup(this, 'TriggerList', 10, ' Del ');\" name=\"TriggerList\" value=\"<#CTL_del#>\"/></td>";
	  ...
	  <td bgcolor="#FFFFFF">
	    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" class="FormTable">
          ...
          <tr>
            ...
            <td colspan="3">
			  <input type="radio" value="1" name="autofw_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'IPConnection', 'autofw_enable_x', '1')" <% nvram_match_x("IPConnection","autofw_enable_x", "1", "checked"); %>>Yes</input>
			  <input type="radio" value="0" name="autofw_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'IPConnection', 'autofw_enable_x', '0')" <% nvram_match_x("IPConnection","autofw_enable_x", "0", "checked"); %>>No</input>
			</td>
		  </tr>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td align="center">
              <input class="button" type="submit" onClick="return trigger_markGroup(this, 'TriggerList', 10, ' Add ');" name="TriggerList2" value="<#CTL_add#>">			</td>
            </tr>
        </table>
