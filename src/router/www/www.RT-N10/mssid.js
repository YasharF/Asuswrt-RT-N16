...
var mssidlist=[[0, '1',
               ...
               [1, '0',
                '<% nvram_char_to_ascii("WLANConfig11b", "mbss1_ssid"); %>',
...
function add_ssid_event(){
	if(get_free_mssid() == 0){
		alert("Your can add at most 2 SSID.\n\n Please click red arrow to pull down select menu to modify exist SSID settings.");
	}
	else
