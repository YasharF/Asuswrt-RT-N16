...
function showGWStaticList(){
	...
	if(GWStaticList.length == 0)
		...
		if(i == 0)
			code +="<td width='75' style='background:#C0DAE4;' rowspan=" + GWStaticList.length + "><input style=\"padding:2px 2px 0px 2px\" class=\"button\" type=\"submit\" onclick=\"markGroup(this, 'GWStatic', 16, ' Del ');\" value=\"<#CTL_del#>\"/></td>";
			...
			<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
			  ...
			  <tr>
				...
				<tr>
					...
					<td>
						<input type="radio" value="1" name="dr_enable_x" class="input" onClick="return change_common_radio(this, 'RouterConfig', 'dr_enable_x', '1')" <% nvram_match_x("RouterConfig","dr_enable_x", "1", "checked"); %>>Yes
						<input type="radio" value="0" name="dr_enable_x" class="input" onClick="return change_common_radio(this, 'RouterConfig', 'dr_enable_x', '0')" <% nvram_match_x("RouterConfig","dr_enable_x", "0", "checked"); %>>No
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="radio" value="1" name="mr_enable_x" class="input" onClick="return change_common_radio(this, 'RouterConfig', 'mr_enable_x', '1')" <% nvram_match_x("RouterConfig","mr_enable_x", "1", "checked"); %>>Yes
						<input type="radio" value="0" name="mr_enable_x" class="input" onClick="return change_common_radio(this, 'RouterConfig', 'mr_enable_x', '0')" <% nvram_match_x("RouterConfig","mr_enable_x", "0", "checked"); %>>No
					</td>
				</tr>
				<!-- 2008.03 James. patch for Oleg's patch. } -->
			  ...
			  <tr>
			    ...
			    <td>
				  <input type="radio" value="1" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '1')" <% nvram_match_x("RouterConfig","sr_enable_x", "1", "checked"); %> />Yes
				  <input type="radio" value="0" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '0')" <% nvram_match_x("RouterConfig","sr_enable_x", "0", "checked"); %> />No
				</td>
			  </tr>
			</table>
			...
			<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
			  ...
			  <tr>
				...
				<td width="75" align="center">
					<!-- 2008.03 James. patch for Oleg's patch. { -->
					<input class="button" type="submit" onClick="return GWStatic_markGroup(this, 'GWStatic', 16, ' Add ');" name="GWStatic" value="<#CTL_add#>" size="12">
					<!-- 2008.03 James. patch for Oleg's patch. } -->
				</td>
			  </tr>
			</table>
