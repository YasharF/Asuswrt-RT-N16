...
productid = 'RT-N10';//'<% nvram_get_f("general.log","productid"); %>';
...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span class="top-messagebold" title="<#OP_desc1#>"><#menu5_6_1#>: </span><a href="/Advanced_OperationMode_Content.asp"><span id="sw_mode_span" class="time"></span></a>\n';	
	banner_code +='</td>\n';
...
menuL1_link = new Array("", "index.asp", "EZQoS.asp", "as.asp");
...
function show_top_status(){
	...
	if(sw_mode == "1")  // Show operation mode in banner, Lock add at 2009/02/19
		$("sw_mode_span").innerHTML = "<#OP_RT_item#>";
	else if(sw_mode == "2")
