	...
	<input type="text" maxlength="2" class="input" size="2" name="filter_lw_time_x_endmin" onKeyPress="return is_number(this)">		  
		...
		<thead>
          ...
          <tr>
            ...
            <td rowspan="3" valign="bottom" bgcolor="#FFFFFF"><input class="button" type="submit" onclick="if(validForm()){return markGroup(this, 'LWFilterList', 32, ' Add ');}" name="LWFilterList" value="<#CTL_add#>" size="12"/></td>
          </tr>
          <tr align="center">
            <td><#FirewallConfig_LanWanSrcIP_itemname#></td>
            <td><#FirewallConfig_LanWanSrcPort_itemname#></td>
            <td><#FirewallConfig_LanWanDstIP_itemname#></td>
            <td><#FirewallConfig_LanWanDstPort_itemname#></td>
            <td><#FirewallConfig_LanWanProFlag_itemname#></td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input class="button" type="submit" onclick="return markGroup(this, 'LWFilterList', 32, ' Del ');" name="LWFilterList2" value="<#CTL_del#>" style="font-size:11px; margin:0px 0px 0px 5px; padding:0px 3px 0px 3px;"></td>
          </tr>
          <tr align="right">
            <td colspan="6"><input name="button" type="button" class="button" onclick="applyRule()" value="<#CTL_apply#>"/></td>
		  </tr>
        </table>
		</td>
	</tr>
