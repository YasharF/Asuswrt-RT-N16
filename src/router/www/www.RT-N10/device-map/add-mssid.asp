...
var idx = get_free_mssid(); //index of free ssid;
...
<input type="hidden" name="wl_wpa_mode" id="wpa_mode" value="<% nvram_get_x("WLANConfig11b", "wl_wpa_mode"); %>">
...
<table width="95%" class="popTable" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tbody>
		<tr>
			<th width="40%" >內建SSID組合</th>
			<td>
				<input type="radio" name="SSID_profile" value="1" onclick="change_profile(this);">guest
				<input type="radio" name="SSID_profile" value="2" onclick="change_profile(this);">VIP
				<input type="radio" name="SSID_profile" value="0" onclick="change_profile(this);" checked>自訂
				<!--select class="input" name="SSID_profile" id="" onchange="change_profile(this);">
					<option>自訂</option>
	      	<option>VIP</option>
	      	<option>guest</option>
...
<table width="95%" class="popTable" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr id="Enable_ssid_tr">
    <th width="40%">啟用</th>
		<td>
	  	<input id="mbss_enable1" type="radio" name="enabled" value="1" checked>是
	  	<input id="mbss_enable0" type="radio" name="enabled" value="0" >否
		</td>
  </tr>
  ...
  <tr id="mssid_closed_tr">
    <th><#WLANConfig11b_x_BlockBCSSID_itemname#></th>
		<td>
			<input type="radio" value="1" id="mbss_closed1" name="closed" class="input">是
			<input type="radio" value="0" id="mbss_closed0" name="closed" class="input" checked>否
		</td>
  </tr>
  <!--tr>
    <th width="95">有效時間</th>
    ...
    <tr bgcolor="#FFFFFF" style="border-bottom:1px solid #666">
    	<td colspan="2" align="right">
    		<span style="color:red; font-size:11px;">新增後，請按下「儲存」才會生效。</span>
