        ...
        <tr>
          <td valign="top" >          
            <table width="550" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              ...
              <tr>
                <td align="center"><textarea style="width:98%; font-family:'Courier New', Courier, mono; font-size:13px;" cols="63" rows="15" readonly="readonly" wrap=off ><% nvram_dump("iptable.log","iptable.sh"); %></textarea></td><!--==magic 2008.11 del name ,if there are name, when the form was sent, the textarea also will be sent==-->
              </tr>
			  <tr align="right">
