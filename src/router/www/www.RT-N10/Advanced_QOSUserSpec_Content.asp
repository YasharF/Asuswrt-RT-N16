					...
					<td bgcolor="#FFFFFF">		
						<table width="100%"  border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
							...
							<tr>
								...
								<th style="text-align:center;"><#BM_UserList2#></th>
								<th style="text-align:center;"><#BM_UserList3#></th>
							...
							<tr>
								...
								<td><input type="text" maxlength="10" size="10" name="qos_port_x_0" class="input" onKeyPress="return is_portrange(this)"></td>
								<td width="70">
