	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			<tr>
			  ...
			  <td>
			  	<input type="radio" value="1" name="wl_radio_x" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_radio_x', '1')" <% nvram_match_x("WLANConfig11b","wl_radio_x", "1", "checked"); %>>Yes
			    <input type="radio" value="0" name="wl_radio_x" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_radio_x', '0')" <% nvram_match_x("WLANConfig11b","wl_radio_x", "0", "checked"); %>>No
			  </td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<select name="wl_frameburst" class="input" onChange="return change_common(this, 'WLANConfig11b', 'TxBurst')">
			...
			<tr>
				<th><#WLANConfig11n_PremblesType_itemname#></th>
				<td>
					<select name="wl_plcphdr" class="input" onChange="return change_common(this, 'WLANConfig11b', 'wl_plcphdr')">
