...
<title>ASUS Wireless Router <#Web_Title#> - <#menu5_7_5#></title>
...
<body onload="show_banner(1); show_menu(5,7,4); show_footer();">
        ...
        <tr>
          <td valign="top" >          
            <table width="550" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              <thead>
                <tr>
                  <td><#menu5_7#> - <#menu5_7_5#></td>
                </tr>
              </thead>
              <tr>
                <td align="center"><textarea style="width:98%; font-family:'Courier New', Courier, mono; font-size:13px;" cols="63" rows="15" readonly="readonly" wrap=off ><% nvram_dump("iptable.log","iptable.sh"); %></textarea></td>
              </tr>
			  <tr align="right">
			  <td><!--input class="button" onclick="onSubmitCtrl(this, ' Refresh ')" type="submit" value="<#CTL_refresh#>" name="action" /-->
