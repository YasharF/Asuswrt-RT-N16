...
helptitle[3] = [["", ""],
				...
				["<#WLANConfig11b_x_IsolateAP_itemname#>", "wl_ap_isolate"], // 5
				...
				["<#WLANConfig11b_x_RTS_itemname#>", "wl_rts"], // 10
				...
				["<#WLANConfig11b_x_NOACK_itemname#>", "wl_wme_no_ack"], // 15
				...
				["<#WLANConfig11b_x_HT_OpMode_itemname#>", "wl_mimo_preamble"],
...
//AiDisk Wizard
helptitle[15] = [["", ""],
				["<a href='../Advanced_AiDisk_samba.asp' target='_parent' hidefocus='true'><#t1USB#></a>", ""],
...
helptitle[17] = [["", ""],
				...
				["<#ShareNode_InitialScript_itemname#>", "run_prog"],
				["<#ShareNode_FTPLANG_itemname#>", ""],
...
helpcontent[3] = new Array("",
						   ...
						   "<#WLANConfig11b_x_IsolateAP_itemdesc#>", 	//5
...
helpcontent[15] = new Array("",
							"<#AiDisk_moreconfig#>",
							//"<#AiDisk_Step1_help#><span style='color:#CC0000'><#AiDisk_Step1_help2#></span>",
							"<#AiDisk_Step1_help#>",
							"<#AiDisk_Step2_help#>",
							"<#AiDisk_Step3_help#>");
