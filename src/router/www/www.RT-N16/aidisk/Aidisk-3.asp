...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	<tr>
		<td colspan="2" class="textbox">
			...
			<input type="radio" name="check_asus_ddns" <% nvram_match_x("LANHostConfig", "asusddns_tos_agreement", "1", "checked"); %> onClick="switch_ddns();">
			<span><#DDNSterm_agreeword#> <a href="#" onclick="parent.show_help_iframe(5);"><#DDNS_termofservice_Title#></a>.</span><br/>
