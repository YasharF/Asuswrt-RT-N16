	...
	if(document.form.wl_macmode.value == "allow"){
		if(wl_macnum_x == 0){
			if(confirm("<#FirewallConfig_MFList_accept_hint1#>")){
				...
				markGroup(document.form.ACLList2, 'ACLList', 16, ' Add ');
				document.form.submit();
			}
			else
				return false;
...
<body onload="show_banner(1); show_menu(5,1,4); show_footer();">
	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
          ...
          <tr>
            <th width="30%"><#FirewallConfig_MFhwaddr_itemname#>
			  ...
			  <td>
                ...
                <input class="button" type="submit" onclick="return markGroup(this, 'ACLList', 32, ' Add ');" name="ACLList2" value="<#CTL_add#>" size="12"/>
          ...
          <tr>
            ...
            <td>
			<select size="8" name="ACLList_s" multiple="multiple" class="input" style="font-size:12px; font-weight:bold; vertical-align:middle;">
              <% nvram_get_table_x("DeviceSecurity11a","ACLList"); %>
            </select>
              <input class="button" type="submit" onClick="return markGroup(this, 'ACLList', 32, ' Del ');" name="ACLList" value="<#CTL_del#>" size="12"></td>
          </tr>
          <tr align="right">
