...
<title>ASUS Wireless Router <#Web_Title#> - <#menu5_7_6#></title>
            ...
            <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              ...
              <tr>
                <td colspan="2" align="center">
                  <textarea style="width:98%; font-family:'Courier New', Courier, mono; font-size:13px;" cols="63" rows="15" readonly="readonly" wrap=off><% nvram_dump("route.log","route.sh"); %></textarea>
				</td>
              </tr>
			  <tr align="right">
			  <td>
