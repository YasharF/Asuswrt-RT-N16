	  ...
	  <td bgcolor="#FFFFFF">		
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
          <tr>
            ...
            <td width="300"><input type="radio" value="1" name="fw_enable_x"  onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '1')" <% nvram_match_x("FirewallConfig","fw_enable_x", "1", "checked"); %>><#checkbox_Yes#>
          ...
          <tr>
            <th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,4);"><#FirewallConfig_x_WanLPREnable_itemname#></a></th>
            <td>
              <input type="radio" value="1" name="misc_lpr_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_lpr_x', '1')" <% nvram_match_x("FirewallConfig","misc_lpr_x", "1", "checked"); %>><#checkbox_Yes#>
              <input type="radio" value="0" name="misc_lpr_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_lpr_x', '0')" <% nvram_match_x("FirewallConfig","misc_lpr_x", "0", "checked"); %>><#checkbox_No#>
			</td>
          </tr>
          <tr>
