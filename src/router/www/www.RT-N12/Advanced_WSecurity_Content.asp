	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			<tr>
			  ...
			  <td><input type="text" maxlength="15" class="input" size="15" name="wl_radius_ipaddr" value="<% nvram_get_x("WLANAuthentication11a","wl_radius_ipaddr"); %>" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
			  </tr>
			<tr>
			  <th >
			...
			<tr>
				...
				<td>
				  <input type="password" maxlength="64" class="input" size="32" name="wl_radius_key" value="<% nvram_get_x("WLANAuthentication11a","wl_radius_key"); %>"></td>
			</tr>
			<tr align="right">
