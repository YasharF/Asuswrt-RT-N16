	...
	if(b == " Add "){
		if (document.form.sr_num_x_0.value > c){
			...
			return false;
				 ...
				 !validate_range(document.form.sr_matric_x_0, 1, 16)){
				 return false;
		}
			...
			<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
			  ...
			  <tr>
				...
				<tr>
					...
					<td>
						<input type="radio" value="1" name="mr_enable_x" class="input" onClick="return change_common_radio(this, 'RouterConfig', 'mr_enable_x', '1')" <% nvram_match_x("RouterConfig", "mr_enable_x", "1", "checked"); %>><#checkbox_Yes#>
						<input type="radio" value="0" name="mr_enable_x" class="input" onClick="return change_common_radio(this, 'RouterConfig', 'mr_enable_x', '0')" <% nvram_match_x("RouterConfig", "mr_enable_x", "0", "checked"); %>><#checkbox_No#>
					</td>
				</tr>
				<!-- 2008.03 James. patch for Oleg's patch. } -->
