        ...
        <tr>
          <td valign="top">
            <table width="550" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              ...
              <tr>
                <td align="center">
									<textarea cols="63" rows="15" readonly="readonly" wrap=off style="font-family:'Courier New', Courier, mono; font-size:13px;"><% nvram_dump("leases.log", "leases.sh"); %></textarea>
								</td><!--==magic 2008.11 del name ,if there are name, when the form was sent, the textarea also will be sent==-->
              </tr>
              
			  <tr align="right">
			  <td><input type="submit" class="button" onClick="onSubmitCtrl(this, ' Refresh ')" value="<#CTL_refresh#>" name="action" /></td>
			  </tr>
            </table>
			</form>
			</td>
