...
function initial(){
	...
	free_mssid = get_free_mssid();
	
	wl_auth_mode_change(1);
	show_LAN_info();
	domore_create();
	
	if(wps_proc_status == "1" && wps_mode == "enabled" && sw_mode == "1"){
		PBC_shining();
	}
...
function UIunderRepeater(){
	...
	$("wps_pbc_tr").style.display = "none";
	$("ssid_check0").style.display = "none";
	...
	$("ssid_input").style.border = "0px";
	$("ssid_input").style.background = "transparent";
	$("ssid").className = "inputinfo";
	$("sta_asuskey1").className = "inputinfo";
	$("wpa_psk").className = "inputinfo";
}
...
function show_LAN_info(){
	var lanip = '<% nvram_get_x("LANHostConfig", "lan_ipaddr_t"); %>';
	lanip = (lanip == "")?"<% nvram_get_x("LANHostConfig", "lan_ipaddr"); %>":lanip;
	
	showtext($("LANIP"), lanip);
...
<table width="310" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
    <th id="toolbar-th">
    	SSID <input id="Add-SSID-btn" type="button" class="sbtn" value="<#CTL_add#>" onclick="add_ssid_event();" style="visibility:hidden;padding:0 2px; margin:0px;">
    </th>
    <td id="toolbar-td">
    	<div id="mssid_arrow" onclick="pullMSSIDList(this);" title="Select Multi-SSID"></div>
      	...
      	<input type="text" id="ssid" name="wl_ssid" value="<% nvram_get_x("WLANConfig11b", "wl_ssid"); %>" maxlength="32" size="22" autocomplete="off"  onClick="hideMSSID_Block();" class="nocssinput" onblur="if(!mssid_duplicate(this)){return false;};" onfocus="parent.showHelpofDrSurf(0, 1);" />
  ...
  <tr-->
  <tr>
    <th width="120"><#WLANConfig11b_AuthenticationMethod_itemname#></th>
    <td>
      <select id="auth_mode" name="wl_auth_mode" class="input" onchange="change_auth_mode(this);" onfocus="parent.showHelpofDrSurf(0, 5);">
...
<table width="310" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
	<th width="120"><#WLANConfig11b_WEPType_itemname#></th>
	<td>
	  <select name="wl_wep_x" id="wep_x" class="input" onchange="change_wlweptype(this);" onfocus="parent.showHelpofDrSurf(0, 9);">
...
<table width="310" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
    ...
    <td>
      <select name="wl_key" id="key" class="input" onfocus="parent.showHelpofDrSurf(0, 10);">
  ...
  <tr>
    <th width="120"><#WLANConfig11b_WEPKey_itemname#></th>
    <td>
      <input type="text" id="sta_asuskey1" name="wl_asuskey1" onKeyUp="return change_wlkey(this, 'WLANConfig11b');" value="" size="22" class="input"/>
    </td>
  </tr>
</table>
</div>
...
<table width="310" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
	<th width="120"><#WLANConfig11b_WPAType_itemname#></th>
	<td>
	  <select id="crypto" name="wl_crypto" class="input" onchange="wl_auth_mode_change(0);" onfocus="parent.showHelpofDrSurf(0, 6);">
...
<table width="310" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
    <th width="120"><#WPA-PSKKey#></th>
    <td>
      <input type="text" id="wpa_psk" name="wl_wpa_psk" value="" size="22" maxlength="64" class="input" onfocus="parent.showHelpofDrSurf(0, 7);"/>
    </td>
  </tr>
</table>
</div>
...
<table width="310" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <!--tr>
    <th width="120"><#Wireless_Radio#></th>
	<td>
  ...
  <tr id="Enable_ssid_tr" style="display:none;">
    <th width="120"><#btn_Enable#> SSID</th>
		<td>
	  	<input type="radio" name="wl_ssid_x_enable" value="1" checked><#checkbox_Yes#>
	  	<input type="radio" name="wl_ssid_x_enable" value="0" ><#checkbox_No#>
		</td>
  </tr-->
  <tr id="mssid_network_tr" style="display:none;">
    <th width="120"><#mssid_network_access#></th>
		<td>
  ...
  <tr id="mssid_qos_tr" style="display:none;">
    <th width="120"><#mssid_qos_priority#></th>
		<td>
  ...
  <tr id="mssid_closed_tr" style="display:none;">
    <th width="120"><#WLANConfig11b_x_BlockBCSSID_itemname#></th>
		<td>
  ...
  <tr>
    <th width="120"><#LAN_IP#></th>
    <td id="LANIP"></td>
  </tr>
  <tr>
    <th width="120"><#PIN_code#></th>
    <td id="PINCode"></td>
  </tr>
  <tr>
    <th width="120"><#MAC_Address#></th>
    <td id="MAC"></td>
  </tr>
  <tr id="wps_pbc_tr">
    <th width="120">WPS</th>
