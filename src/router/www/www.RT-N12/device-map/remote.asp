...
<script>
var remoteIP = '<% nvram_get_x("LANHostConfig", "lan_gateway_now"); %>'
...
<table width="95%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
    ...
    <td><span id="Connstatus"></span></td>
  </tr>
  <tr id="remoteIP_tr">
    <th width="120"><#AP_Remote_IP#></th>
    <td width="150"><span id="remoteIP_span"></span></td>
  </tr>
  <tr>
    <th><#AP_survey#></th>
    <td><input type="button" class="sbtn" value="<#btn_go#>" onclick="javascript:parent.location.href='../survey.asp';" onmouseover="sbtnOver(this);" onmouseout="sbtnOut(this);"></td>
  </tr>   
</table>
</body>
</html>
