...
<title>ASUS Wireless Router <#Web_Title#> - <#menu5_6_1#></title>
...
function changeSena(obj, mode){
	...
	$('Tab_'+ sw_mode).style.background = "url(images/tab_rt0.gif) 0 bottom no-repeat";
		...
		<td height="430" valign="top">
			...
			<div style="background-color:#547fb6; width:100%; padding-left:3px;">
				<table border="0" cellspacing="0" cellpadding="0" height="30">
					<tr>
						<td height="30" id="Tab_1" class="b2" onclick="changeSena(this, 'rt');" style="background:url(images/tab_rt0.gif) 0 bottom no-repeat">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Router</td>
						<td height="30" id="Tab_2" class="b2" onclick="changeSena(this, 're');" style="background:url(images/tab_re0.gif) 0 bottom no-repeat">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Repeater</td>
						<td height="30" id="Tab_3" class="b2" onclick="changeSena(this, 'ap');" style="background:url(images/tab_ap0.gif) 0 bottom no-repeat">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AP</td>
					</tr>
				</table>
			</div>
					...
					<td align="left" valign="top" width="550">
						<div id="Senario">
						  ...
						  <object id="radio2" style="position:absolute; margin:90px 0px 0px 240px; background:transparent;" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="85" height="85">
							...
							<div id="ap-line" style="margin:107px 0px 0px 243px;width:94px; height:35px; position:absolute; background:url(images/wanlink.gif) no-repeat; display:none;"></div>
							...
							<table width="100%" cellpadding="0" cellspacing="1" class="Help" bgcolor="#999999">
								...
								<tr>
									<td valign="top">
										...
										<div class="hint_body2"><#OP_switch_button_hint1#><a href="#" onclick="show_SwitchHint();"><#OP_switch_button_hint2#></a></div>
