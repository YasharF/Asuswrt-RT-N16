...
var test_page = 0;
var testEventID = "";
var dr_surf_time_interval = 10;	// second
...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span class="top-messagebold" title="<#OP_desc1#>"><#menu5_6_1_title#>: </span><a href="/OperationMode.asp"><span id="sw_mode_span" class="time"></span></a>\n';
	banner_code +='</td>\n';
...
tabtitle[3] = new Array("", "<#menu5_4_2#>", "<#menu5_4_3#>");
tabtitle[4] = new Array("", "<#menu5_5_1#>", "<#menu5_5_2#>", "<#menu5_5_3#>", "<#menu5_5_4#>");
tabtitle[5] = new Array("", "<#menu5_6_2#>", "<#menu5_6_3#>", "<#menu5_6_4#>");
...
tablink[3] = new Array("", "Advanced_AiDisk_ftp.asp", "Advanced_AiDisk_others.asp");
...
menuL1_title = new Array("", "<#menu1#>", "<#menu5_6_1#>", "<#menu3#>", "<#menu4#>", "<#menu5#>");
menuL1_link = new Array("", "index.asp", "OperationMode.asp", "aidisk.asp", "EZQoS.asp", "as.asp");

function show_menu(L1, L2, L3){

	if(productid == "RT-N12" || productid == "RT-N10"){
	...
	if(sw_mode == "2" || sw_mode == "3"){
		...
		if(sw_mode == "2"){
			tabtitle[0].splice(1,5);// Only wl professional
			tablink[0].splice(1,5); // Only wl professional
...
function show_top_status(){
	...
	ssid2 = decodeURIComponent(document.form.wl_ssid2.value);	
...
function reboot(){
	if(confirm("<#Main_content_Login_Item7#>")){
		...
		showLoading(37);
		setTimeout("location.href = '/index.asp';", 37000);
