...
<table height="22" width="666">
  ...
  <tr bgcolor="#FFFF00"> 
    <td class="content_desc_td_home"> 
      <p align="center">
      <p align="left" style="color: #660066; font-size: 14pt; margin-top: 0; margin-bottom: 0; margin-left: 25"><b><#HP_RT_title#></b>    
      <ul>
        <li> 
          <p style="word-spacing: 0; margin-top: 0; margin-bottom: 0"> <a href="javascript:top.openBranch('<#t1Quick#>')"><b><#t1Quick#></b></a> 
          <#HP_quick_desc#></li>     
        <li> <b><a href="javascript:top.openBranch('<#t1Wireless#>')"><#HP_gwpa_desc#></a> &nbsp;</b><#HP_wlang_desc#></li>                
        <li> <b><a href="Advanced_GWStaticRoute_Content.asp"><#HP_route_desc1#></a></b> <#HP_route_desc2#></li>    
