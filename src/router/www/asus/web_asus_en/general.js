...
*/
//else if (!validate_share(document.form.sh_name_0)) return false;
...
{//alert("You can not use 'Guest' as an user name!!!");
//alert(translate_lang('JS_validusername',document.form.preferred_lang.value));
alert("<#JS_validusername#>");
return false;
}
else if (document.form.acc_username_0.value.toLowerCase()=="anonymous")
{
//alert(translate_lang('JS_validusernamea',document.form.preferred_lang.value));
alert("<#JS_validusernamea#>");
return false;
}
else if (document.form.acc_username_0.value.toLowerCase()=="ftp")
{
//alert(translate_lang('JS_validusernameb',document.form.preferred_lang.value));
...
//}
//else {}
//	change_wireless_bridge(o.value, rcheck(document.form.wl_wdsapply_x),/* rcheck(document.form.wl_lazywds),*/ 0, 1);
...
else{}// change_wireless_bridge(document.form.wl_mode_x.value, /*, rcheck(document.form.wl_lazywds),*/ 0);
}
...
else if (s=="WLANConfig11b" && v=="wl_gmode") //For 802.11G-prot is not enable issue (wl_gmode_check->wl_gmode)
...
//	}
//	else {/* enable/disable network key 1 to 4 */
/*
		if (wep != "0") {
...
//		document.form.wl_crypto[0].value = algos[i].toLowerCase();
	}
	else if(mode == "wpa2") {
		algos = new Array("AES");
		document.form.wl_crypto.length = algos.length;
