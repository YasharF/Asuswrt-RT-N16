...
function generateTree()
    ...
    {  
           ...
           if(isModel() != 'WL520gu') //2007.06.12 Yau add for ASUSDDNS function
           {
	   ...
	   if (mode == 'Gateway')
	   {
    	   ...
    	   //}       
    	   if (isModel() == 'WL500'|| isModel() == 'WL331' || isModel() == 'WL520gu')
    	   {
     ...
     if (isModel() != 'WL300' && isModel() != 'WL520gc' && isModel() != 'SnapAP' && isFlash() != '2MB' && isModel() != 'WL520gu')
     {
...
//Mark by Yen for test firmware
     if ((isModel() == 'WL500'||isModel() == 'WL520gu' )&& isFlash() != '2MB' && mode!='AP')
     {
