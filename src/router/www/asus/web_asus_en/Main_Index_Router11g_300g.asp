    ...
    <td class="content_desc_td_home"> 
      ...
      <ul>
        <li> 
          ...
          <#HP_quick_desc#></li>     
        <li> <b><a href="javascript:top.openBranch('<#t1Wireless#>')">HP_wpa_desc1</a> &nbsp;</b><#HP_wlang_desc#></li>        
        <li> <b><a href="javascript:top.openBranch('<#t1Route#>')"><#HP_route_desc1#></a></b> <#HP_route_desc2#></li>    
