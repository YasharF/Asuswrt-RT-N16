...
*/
      ...
      {"VSList", "Group", validate_group, ARGV(variables_IPConnection_VSList, "16", "63", "vts_num_x"), FALSE, FALSE},     
       
      {"TriggerList", "Group", validate_group, ARGV(variables_IPConnection_TriggerList, "8", "56", "autofw_num_x"), FALSE, FALSE},     
      ...
      {"ConnectionStatus", "Status", NULL, ARGV("wan.log","WANLink"), FALSE, FALSE},
             ...
             {"wan_pppoe_mru", "", validate_range, ARGV("576", "1492", ""), FALSE, FALSE},
                ...
                {"wan_hwaddr_x", "", validate_hwaddr, NULL, FALSE, FALSE},
                    ...
                    {"wan_heartbeat_x", "", validate_string, ARGV("32"), FALSE, FALSE},                                                                                                                   
      ...
      {"LWFilterList", "Group", validate_group, ARGV(variables_FirewallConfig_LWFilterList, "16", "55", "filter_lw_num_x"), FALSE, FALSE},     
       
      {"UrlList", "Group", validate_group, ARGV(variables_FirewallConfig_UrlList, "32", "36", "url_num_x"), FALSE, FALSE},     
      ...
      {"DmzDHCPLog", "Status", NULL, ARGV("dleases.log",""), FALSE, FALSE},
              ...
              {"time_zone", "", validate_choice, ARGV(              
                   ...
                   "NST3.30NDT:(GMT-03:30) Newfoundland",
                   ...
                   "RFT-6RFTDST:(GMT+06:00) Almaty, Novosibirsk",
              
                   "UCT-6.30:(GMT+06:30) Rangoon",
              
                   "UCT-7:(GMT+07:00) Bangkok, Hanoi, Jakarta",
              
                   "RFT-7RFTDST:(GMT+07:00) Krasnoyarsk",
                   ...
                   "UCT_8:(GMT+08:00) Irkutsk, Ulaan Bataar",
              
                   "KST-9KDT:(GMT+09:00) Seoul",
              
                   "JST:(GMT+09:00) Osaka, Sapporo, Tokyo",
              
                   "RFT-9RFTDST:(GMT+09:00) Yakutsk",
                   ...
                   "UCT-10_6:(GMT+10:00) Canberra, Melbourne, Sydney",
