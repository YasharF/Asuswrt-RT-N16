...
var qos_pshack='<%ejGet(qos_pshack_prio)%>';            
var qos_shortpkt='<%ejGet(qos_shortpkt_prio)%>';     
var qos_service='<%ejGet(qos_service)%>'; 
var qos_tos='<%ejGet(qos_tos_prio)%>';    
*/
var qos_global_enable_x="<% nvram_get_x("PrinterStatus", "qos_global_enable"); %>";
var qos_pshack="<% nvram_get_x("PrinterStatus", "qos_pshack_prio"); %>";            
var qos_shortpkt="<% nvram_get_x("PrinterStatus", "qos_shortpkt_prio"); %>";     
var qos_service_enable_x="<% nvram_get_x("PrinterStatus", "qos_service_enable"); %>"; 
var qos_tos="<% nvram_get_x("PrinterStatus", "qos_tos_prio"); %>";    
