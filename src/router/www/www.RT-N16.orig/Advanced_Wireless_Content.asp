...
var wl_phrase_x_org = '<% nvram_char_to_ascii("WLANConfig11b", "wl_phrase_x"); %>';
...
function initial(){
	...
	document.form.wl_phrase_x.value = decodeURIComponent(wl_phrase_x_org);
...
<input type="hidden" name="HT_EXTCHA_old" value="<% nvram_get_x("WLANConfig11b","HT_EXTCHA"); %>"> <!-- Templated UI -->
		  ...
		  <td bgcolor="#FFFFFF">
			<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
			  ...
			  <tr>
				...
				<td>
					<select name="wl_gmode" class="input" onChange="return change_common(this, 'WLANConfig11b', 'wl_gmode')">
						<option value="0" <% nvram_match_x("WLANConfig11b","wl_gmode", "0","selected"); %>>Auto</option>
						<option value="1" <% nvram_match_x("WLANConfig11b","wl_gmode", "1","selected"); %>>b/g Mixed</option>
						<option value="2" <% nvram_match_x("WLANConfig11b","wl_gmode", "2","selected"); %>>n Only</option>
						<option value="3" <% nvram_match_x("WLANConfig11b","wl_gmode", "3","selected"); %>>g Only</option>
						<option value="4" <% nvram_match_x("WLANConfig11b","wl_gmode", "4","selected"); %>>b Only</option>
					</select>
				  <input type="checkbox" style="margin-left:30" name="wl_gmode_check" value="" onClick="return change_common(this, 'WLANConfig11b', 'wl_gmode_check', '1')">
			  ...
			  <tr>
			    ...
			    <td>
				<select name="wl_nbw_cap" class="input" onChange="return change_common(this, 'WLANConfig11b', 'wl_nbw_cap')">
					<option class="content_input_fd" value="0" <% nvram_match_x("WLANConfig11b","wl_nbw_cap", "0","selected"); %>>20 MHz</option>
					<option class="content_input_fd" value="1" <% nvram_match_x("WLANConfig11b","wl_nbw_cap", "1","selected"); %>>20/40 MHz</option>
				</select>				
				</td>
			    </tr>
			  <tr>
