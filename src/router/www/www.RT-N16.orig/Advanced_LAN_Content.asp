...
//jumbo_frame_enable = '<% nvram_get_x("LANHostConfig",  "jumbo_frame_enable"); %>';
...
/*
	if (jumbo_frame_enable == "1")
		inputCtrl(document.form.jumbo_frame_size, 1);
	else
		inputCtrl(document.form.jumbo_frame_size, 0);
*/
}
...
//	if(jumbo_frame_enable == "1") {
//		if(!validate_range(document.form.jumbo_frame_size, 1, 9720)) {
//			return false;
//		}
//	}
	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
		  ...
		  <tr>
			...
			<td>
			  <input type="text" maxlength="15" class="input" size="15" name="lan_ipaddr" value="<% nvram_get_x("LANHostConfig","lan_ipaddr"); %>" onKeyPress="return is_ipaddr(this);" onKeyUp="change_ipaddr(this);">
			</td>
		  </tr>
		  ...
		  <tr>
			...
			<td>
			  ...
			  <input type="hidden" name="dhcp_end" value="<% nvram_get_x("LANHostConfig", "dhcp_end"); %>">
                                ...
                                <tr>
                                        <th>
                                                <a class="hintstyle" href="javascript:openHint(14, 1);"><#BasicConfig_EnableMediaServer_itemname#></a>
                                        </th>
                                        <td>
                                                <input type="radio" name="upnp_enable" value="1" <% nvram_match_x("Storage", "upnp_enable", "1", "checked"); %>><#checkbox_Yes#>
                                                <input type="radio" name="upnp_enable" value="0" <% nvram_match_x("Storage", "upnp_enable", "0", "checked"); %>><#checkbox_No#>
                                        </td>
                                </tr>
	                        <tr>
                                        <th>Enable telnetd?</th>
                                        <td>
                                                <input type="radio" name="telnet_enable" value="1" <% nvram_match_x("Storage", "telnet_enable", "1", "checked"); %>><#checkbox_Yes#>
                                                <input type="radio" name="telnet_enable" value="0" <% nvram_match_x("Storage", "telnet_enable", "0", "checked"); %>><#checkbox_No#>
                                        </td>
                                </tr>
	  
                                <tr>
                                        <th>Enable Jumbo Frame?</th>
                                        <td>
                                                <input type="radio" name="jumbo_frame_enable" value="1" onclick="return change_common(this, 'LANHostConfig', 'jumbo_frame_enable', 1)" <% nvram_match_x("LANHostConfig", "jumbo_frame_enable", "1", "checked"); %>><#checkbox_Yes#>
                                                <input type="radio" name="jumbo_frame_enable" value="0" onclick="return change_common(this, 'LANHostConfig', 'jumbo_frame_enable', 0)" <% nvram_match_x("LANHostConfig", "jumbo_frame_enable", "0", "checked"); %>><#checkbox_No#>
                                        </td>
                                </tr>

		  <tr>
			<th>IPTV UDP Multicast to HTTP Proxy Port:</th>
			
			<td>
              		<input type="text" maxlength="15" class="input" size="15" name="udpxy_enable_x" value="<% nvram_get_x("LANHostConfig","udpxy_enable_x"); %>" onkeypress="return is_number(this);"  />0 - disabled 
			</td>
		  </tr>

           			 <!--tr>
			              <th>Size of Jumbo Frame(Bytes)</th>
			              <td><input type="text" maxlength="5" size="5" name="jumbo_frame_size" class="input" value="<% nvram_get_x("LANHostConfig", "jumbo_frame_size"); %>" onkeypress="return is_number(this)" /></td>
				</tr-->
