        ...
        <tr>
          <td valign="top">
            <table width="550" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              ...
              <tr>
                <td align="center">
				<textarea cols="63" rows="15" readonly="readonly" wrap=off style="font-family:'Courier New', Courier, mono; font-size:13px;"><% nvram_dump("leases.log", "leases.sh"); %></textarea></td>
              </tr>
