...
<input name="account" id="account" type="hidden" value="">
  ...
  <thead>
    <tr>
      <td><span><#DelAccountTitle#>: </span><span id="selected_account"></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td height="30" align="right" bgcolor="#E6E6E6">
	    <input id="Submit" type="button" class="button" value="<#CTL_del#>">
  	  <input id="Cancel" type="button" class="button" value="<#CTL_Cancel#>">
	  </td>
    </tr>
  </table>
</form>
