...
<table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" class="FormTitle">
	...
	<legend>
		<span style="font-size:13px; font-weight:bold;">
			<input type="radio" name="sw_mode" class="input" value="1" onclick="setScenerion(1);" <% nvram_double_match_x("IPConnection", "wan_route_x", "IP_Routed", "IPConnection", "wan_nat_x", "1", "checked"); %>><#OP_GW_item#>
			<input type="radio" name="sw_mode" class="input" value="2" onclick="setScenerion(2);" <% nvram_double_match_x("IPConnection", "wan_route_x", "IP_Routed", "IPConnection", "wan_nat_x", "0", "checked"); %>><#OP_RT_item#>
			<input type="radio" name="sw_mode" class="input" value="3" onclick="setScenerion(3);" <% nvram_double_match_x("IPConnection", "wan_route_x", "IP_Bridged","IPConnection", "wan_nat_x", "0", "checked"); %>><#OP_AP_item#>
		</span>
	</legend>
