...
var alert_event6 = new Array("<#web_redirect_reason6#>", "<#DrSurf_referto_diagnosis#>", drdiagnose);  //wan_gateway & lan_ipaddr;
...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span class="top-messagebold"><#General_x_FirmwareVersion_itemname#>: </span><a href="/Advanced_FirmwareUpgrade_Content.asp"><span id="firmver" class="time"></span></a>\n';
	banner_code +='</td>\n';
	...
	banner_code +='<div id="logout_btn" class="buttonquit"><a href="javascript:;" onclick="logout();"><#t1Logout#></a></div>\n';
	banner_code +='<div id="reboto_btn" class="buttonquit"><a href="javascript:;" onclick="reboot();"><#BTN_REBOOT#></a></div>\n';
	banner_code +='</td>\n';
...
tabtitle[0] = new Array("", "<#menu5_1_1#>", "<#menu5_1_2#>", "<#menu5_1_3#>", "<#menu5_1_4#>", "<#menu5_1_5#>", "<#menu5_1_6#>");  //[x][0]為保留欄位
...
tabtitle[3] = new Array("", "<#menu5_4_1#>", "<#menu5_4_2#>", "<#menu5_4_3#>");
...
tabtitle_Router[0] = new Array("", "<#menu5_1_1#>", "<#menu5_1_2#>", "<#menu5_1_3#>", "<#menu5_1_4#>", "<#menu5_1_5#>", "<#menu5_1_6#>");  //[x][0]為保留欄位
tabtitle_Router[1] = new Array("", "<#menu5_2_1#>", "<#menu5_2_2#>", "<#menu5_2_3#>");
tabtitle_Router[2] = new Array("", "<#menu5_3_1#>", "<#menu5_3_2#>", "", "", "", "<#menu5_3_6#>");
tabtitle_Router[3] = new Array("", "<#menu5_4_1#>", "<#menu5_4_2#>", "<#menu5_4_3#>");
tabtitle_Router[4] = new Array("", "<#menu5_5_1#>", "<#menu5_5_2#>", "<#menu5_5_3#>", "<#menu5_5_4#>");
tabtitle_Router[5] = new Array("", "<#menu5_6_1#>", "<#menu5_6_2#>", "<#menu5_6_3#>", "<#menu5_6_4#>");
tabtitle_Router[6] = new Array("", "<#menu5_7_2#>", "<#menu5_7_3#>", "<#menu5_7_4#>", "<#menu5_7_5#>", "<#menu5_7_6#>");
var tablink_Router = new Array(7);   // Use a 2-dimension Array to arrange tab link
tablink_Router[0] = new Array("", "Advanced_Wireless_Content.asp", "Advanced_WWPS_Content.asp", "Advanced_WMode_Content.asp", "Advanced_ACL_Content.asp", "Advanced_WSecurity_Content.asp", "Advanced_WAdvanced_Content.asp");
tablink_Router[1] = new Array("", "Advanced_LAN_Content.asp", "Advanced_DHCP_Content.asp", "Advanced_GWStaticRoute_Content.asp");
tablink_Router[2] = new Array("", "Advanced_WAN_Content.asp", "Advanced_QOSUserSpec_Content.asp", "", "", "", "Advanced_ASUSDDNS_Content.asp");
tablink_Router[3] = new Array("", "Advanced_AiDisk_samba.asp", "Advanced_AiDisk_ftp.asp", "Advanced_AiDisk_others.asp");
tablink_Router[4] = new Array("", "Advanced_BasicFirewall_Content.asp", "Advanced_URLFilter_Content.asp", "Advanced_MACFilter_Content.asp", "Advanced_Firewall_Content.asp");
tablink_Router[5] = new Array("", "Advanced_OperationMode_Content.asp", "Advanced_System_Content.asp", "Advanced_FirmwareUpgrade_Content.asp", "Advanced_SettingBackup_Content.asp");
tablink_Router[6] = new Array("", "Main_LogStatus_Content.asp", "Main_DHCPStatus_Content.asp", "Main_WStatus_Content.asp", "Main_IPTStatus_Content.asp", "Main_RouteStatus_Content.asp");

//Level 3 Tab Menu in AP mode
var tabtitle_AP = new Array(7);
tabtitle_AP[0] = new Array("", "<#menu5_1_1#>", "<#menu5_1_2#>", "<#menu5_1_3#>", "<#menu5_1_4#>", "<#menu5_1_5#>", "<#menu5_1_6#>");  //[x][0]為保留欄位
tabtitle_AP[1] = new Array("", "<#menu5_2_1#>");
tabtitle_AP[2] = new Array("");
tabtitle_AP[3] = new Array("", "<#menu5_4_1#>", "<#menu5_4_2#>", "<#menu5_4_3#>");
tabtitle_AP[4] = new Array("");
tabtitle_AP[5] = new Array("", "<#menu5_6_1#>", "<#menu5_6_2#>", "<#menu5_6_3#>", "<#menu5_6_4#>");
tabtitle_AP[6] = new Array("", "", "", "<#menu5_7_4#>", "", "");
var tablink_AP = new Array(7);   // Use a 2-dimension Array to arrange tab link
tablink_AP[0] = new Array("", "Advanced_Wireless_Content.asp", "Advanced_WWPS_Content.asp", "Advanced_WMode_Content.asp", "Advanced_ACL_Content.asp", "Advanced_WSecurity_Content.asp", "Advanced_WAdvanced_Content.asp");
tablink_AP[1] = new Array("", "Advanced_APLAN_Content.asp");
tablink_AP[2] = new Array("", "");
tablink_AP[3] = new Array("", "Advanced_AiDisk_samba.asp", "Advanced_AiDisk_ftp.asp", "Advanced_AiDisk_others.asp");
tablink_AP[4] = new Array("", "");
tablink_AP[5] = new Array("", "Advanced_OperationMode_Content.asp", "Advanced_System_Content.asp", "Advanced_FirmwareUpgrade_Content.asp", "Advanced_SettingBackup_Content.asp");
tablink_AP[6] = new Array("", "", "", "Main_WStatus_Content.asp", "", "");

//Level 1 Menu in Gateway, Router mode
menuL1_title = new Array("", "<#menu1#>", "<#menu2#>", "<#menu3#>", "<#menu4#>", "<#menu5#>");
menuL1_link = new Array("", "index.asp","upnp.asp", "aidisk.asp", "EZQoS.asp", "as.asp");

//Level 1 Menu in AP mode
menuL1_title_AP = new Array("", "<#menu1#>", "", "<#menu3#>", "", "<#menu5#>");
menuL1_link_AP = new Array("", "index.asp", "", "aidisk.asp", "", "as.asp");
...
menuL2_title_AP = new Array("", "<#menu5_1#>", "<#menu5_2#>", "", "<#menu5_4#>", "", "<#menu5_6#>", "<#menu5_7#>");
