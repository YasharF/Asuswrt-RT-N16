 ...
 * $Id: broadcom.c,v 1.438 2010/02/18 02:07:15 Exp $
 */
...
ej_wl_country_list(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	if (!strcmp(phytype, "a") && (cur_phytype != WLC_PHY_TYPE_N) && (cur_phytype != WLC_PHY_TYPE_SSN) && (cur_phytype != WLC_PHY_TYPE_LCN))
		cl->band = WLC_BAND_5G;
	else if (((!strcmp(phytype, "b")) || (!strcmp(phytype, "g"))) &&
	         (cur_phytype != WLC_PHY_TYPE_N) && (cur_phytype != WLC_PHY_TYPE_SSN) && (cur_phytype != WLC_PHY_TYPE_LCN))
		cl->band = WLC_BAND_2G;
...
ej_wl_channel_list(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	if (wl_ioctl(name, WLC_GET_COUNTRY_LIST, cl, cl->buflen) == 0) {
		for(i = 0; i < cl->count; i++) {
			...
			if ((!strcmp(phytype, "n") || !strcmp(phytype, "s")) &&
			    ((cur_phytype == WLC_PHY_TYPE_N) || (cur_phytype == WLC_PHY_TYPE_SSN) || (cur_phytype == WLC_PHY_TYPE_LCN)))
...
ej_wl_phytypes(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	if (phytype[i] == 'n' || phytype[i] == 'l' || phytype[i] == 's' || phytype[i] == 'c') {
...
ej_wl_nphyrates(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	if ((phytype != WLC_PHY_TYPE_N) && (phytype != WLC_PHY_TYPE_SSN) && (phytype != WLC_PHY_TYPE_LCN))
		return ret;
...
ej_wl_nphy_set(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	return websWrite(wp, "%d", ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN)));
}
...
ej_wl_protection(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	prot_str = ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))?
	...
	ret += websWrite(wp, " %s performance in mixed %s networks. Turn protection <b>Off</b> to "
	                 ...
	                 ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))?
				"802.11n":"802.11g",
	                 ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))?
...
ej_wl_control_string(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	return websWrite(wp, "%s", ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))? "Control":"");
}
...
ej_wl_legacy_string(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	return websWrite(wp, "%s", ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))? "Legacy":"");
}
...
ej_wl_nphy_comment_beg(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	if ((status = wl_phytype_get(wp, &phytype)) != 0)
		return status;
	return websWrite(wp, "%s", ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))? "":"<!--");
}
...
ej_wl_phytype_name(int eid, webs_t wp, int argc, char_t **argv)
{
	...
	return websWrite(wp, "%s", ((phytype == WLC_PHY_TYPE_N) || (phytype == WLC_PHY_TYPE_SSN) || (phytype == WLC_PHY_TYPE_LCN))? "\"wl_nband\"":"\"wl_phytype\"");
}
...
*/
	...
	{ "wl_country_code", "Country Code", wl_prefix, validate_country, NULL, FALSE, NVRAM_MI | VIF_IGNORE | EZC_FLAGS_READ | EZC_FLAGS_WRITE },
	...
	{ "wl_phytype", "Radio Band", wl_prefix, validate_choice, ARGV("a", "b", "g", "n", "l", "s"), TRUE, NVRAM_MI | VIF_IGNORE },
	...
	{ "wl_reg_mode", "Regulatory Mode", wl_prefix, validate_choice, ARGV("off", "h", "d"), FALSE, NVRAM_MI | VIF_IGNORE},
	...
	{ "wl_txchain", "Number of TxChains", wl_prefix, validate_range, ARGV("1", "3"), TRUE, NVRAM_MI | VIF_IGNORE },
	{ "wl_rxchain", "Number of RxChains", wl_prefix, validate_range, ARGV("1", "3"), TRUE, NVRAM_MI | VIF_IGNORE },
