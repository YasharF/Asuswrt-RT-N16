...
#ifdef DEBUG
eprintf("--- discover_all: error on sleect! ---\n");
#endif
#ifdef DEBUG
fprintf(stderr, "--- discover_all: error on sleect! retval=%d, errno=%d. ---\n", retval, errno);
fprintf(stderr, "--- discover_all: got_DHCP=%d, got_PPP=%d. ---\n", got_DHCP, got_PPP);
#endif // DEBUG
			//fprintf(stderr, "error on sleect\n");
		}
#ifdef DEBUG
