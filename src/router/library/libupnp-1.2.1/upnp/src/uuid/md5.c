     ...
     unsigned int inputLen;     /* length of input block */
{
     ...
     */
    index_1 = ( unsigned int )( ( context->count[0] >> 3 ) & 0x3F );
    ...
    if( inputLen >= partLen ) {
        ...
        MD5_memcpy
            ( ( POINTER ) & context->buffer[index_1], ( POINTER ) input,
              partLen );
     ...
     */
    MD5_memcpy
        ( ( POINTER ) & context->buffer[index_1], ( POINTER ) & input[i],
          inputLen - i );
     ...
     MD5_CTX *context;          /* context */
{
    ...
    padLen = ( index_1 < 56 ) ? ( 56 - index_1 ) : ( 120 - index_1 );
