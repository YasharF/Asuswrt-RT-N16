...
iso2022_jp_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, int n)
{
  ...
  /* Extra compatibility with cp932.  */
  {
    int count = (state == STATE_JISX0208 ? 2 : 5);
    if (n < count)
      return RET_TOOSMALL;
    switch (wc) {
      case 0x2225: buf[0] = 0x21; buf[1] = 0x42; break;
      case 0xff0d: buf[0] = 0x21; buf[1] = 0x5d; break;
      case 0xff5e: buf[0] = 0x21; buf[1] = 0x41; break;
      case 0xffe0: buf[0] = 0x21; buf[1] = 0x71; break;
      case 0xffe1: buf[0] = 0x21; buf[1] = 0x72; break;
      case 0xffe2: buf[0] = 0x22; buf[1] = 0x4c; break;
      default:     buf[0] = 0;
    }
    if (buf[0] != 0) {
      if (state != STATE_JISX0208) {
