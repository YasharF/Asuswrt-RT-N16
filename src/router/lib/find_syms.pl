...
#   this script prints a line of the form '-u symbol'.  This can be used
...
of the form '-u symbol' on standard output.
...
{
	foreach my $line (`mipsel-uclibc-nm --dynamic -u --no-sort $bin_file`)
	{
		chomp $line;
		$undef_symtbl{ $line } += 1;
	}
