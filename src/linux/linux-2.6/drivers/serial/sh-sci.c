...
#if defined(CONFIG_SERIAL_SH_SCI_CONSOLE) && defined(CONFIG_SH_STANDARD_BIOS) || \
	defined(CONFIG_SH_KGDB)
...
#if defined(SCI_ONLY) || defined(SCI_AND_SCIF) && defined(__H8300H__) || \
	defined(__H8300S__)
