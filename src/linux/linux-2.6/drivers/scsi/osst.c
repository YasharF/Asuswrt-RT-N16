/*
  ...
  $Header: /projects/cvsroot/src/linux/linux-2.6/drivers/scsi/osst.c,v 1.1.1.1 2007/08/03 18:52:56 Exp $
...
static const char * cvsid = "$Id: osst.c,v 1.1.1.1 2007/08/03 18:52:56 Exp $";
