...
#if defined(CONFIG_CPU_R4300) || defined(CONFIG_CPU_R4X00) || defined(CONFIG_CPU_R5000) \
	|| defined(CONFIG_CPU_RM7000) || defined(CONFIG_CPU_RM9000) || \
	defined(CONFIG_CPU_NEVADA) || defined(CONFIG_CPU_TX49XX) || defined(CONFIG_CPU_MIPS64)
